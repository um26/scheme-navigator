    ...
    <div className="flex flex-wrap gap-2 justify-center">
      {options.map((opt) => (
        <button
          ...
          className={`rounded-full border px-4 py-2 text-sm font-body transition-all duration-150 active:scale-[.97] ${
            value === opt.value
              ? "bg-bottle text-white border-bottle shadow-sm"
              : "bg-white/70 text-ink border-borderc hover:border-bottle hover:bg-white"
          }`}
        >
          {opt.label}
        </button>
    ...
    <div className="rounded-xl border border-borderc bg-white/60 p-6 shadow-sm md:p-8">
        ...
        <div className="space-y-6 text-center animate-fadeIn">
          <div>
            ...
            <input
              ...
              placeholder="e.g. 34"
              className="w-32 rounded-lg border border-borderc bg-white p-2 text-center font-body transition-colors focus:outline-none focus:ring-2 focus:ring-saffron"
            />
      ...
      {current === "location" && (
        <div className="text-center animate-fadeIn">
          ...
          <select
            ...
            className="w-full max-w-sm mx-auto rounded-lg border border-borderc bg-white p-3 font-body transition-colors focus:outline-none focus:ring-2 focus:ring-saffron"
          >
        ...
        <div className="space-y-6 text-center animate-fadeIn">
          <div>
            ...
            <input
              ...
              className="w-48 rounded-lg border border-borderc bg-white p-2 text-center font-body transition-colors focus:outline-none focus:ring-2 focus:ring-saffron"
            />
      ...
      {current === "extra" && (
        <div className="text-center animate-fadeIn">
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-borderc bg-white p-3 font-body transition-colors focus:outline-none focus:ring-2 focus:ring-saffron"
          />
        </div>
      )}
      ...
      <div className="flex items-center justify-between mt-8">
        <button
          ...
          onClick={back}
          disabled={step === 0}
          className="rounded-lg px-4 py-2 font-body text-ink/70 transition-all hover:bg-white/60 active:scale-[.98] disabled:opacity-0"
        >
          {t("guided_back")}
        </button>
        ...
        {step < STEPS.length - 1 ? (
          <button
            type="button"
            onClick={next}
            className="rounded-lg bg-bottle px-6 py-2.5 font-body font-semibold text-white shadow-sm transition-all hover:bg-bottle-light active:scale-[.98]"
          >
            {t("guided_next")}
          </button>
        ) : (
          <button
            ...
            disabled={loading}
            className="rounded-lg bg-saffron-dark px-6 py-2.5 font-body font-semibold text-white shadow-sm transition-all hover:bg-saffron active:scale-[.98] disabled:opacity-50"
          >
