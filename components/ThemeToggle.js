...
export default function ThemeToggle() {
  ...
  function toggleTheme() {
    ...
    window.dispatchEvent(new CustomEvent("sn-theme-change", { detail: { dark: nextDark } }));
    setDark(nextDark);
  }
  ...
  return (
    ...
    >
      <span aria-hidden="true" className={`text-[17px] leading-none transition-transform duration-200 ${dark ? "rotate-12" : ""}`}>
        {dark ? "☀" : "☾"}
      </span>
    </button>
  );
