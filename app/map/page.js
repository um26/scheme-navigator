...
export default function MapPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <h1 className="font-display text-3xl text-ledger text-center">
        Explore schemes by state
      </h1>
      <p className="mt-2 text-center text-ink/70 font-body">
        Click a state or union territory to see schemes available there.
      </p>
      <p className="mt-1 text-center text-xs text-muted font-body">
        Boundaries shown per Survey of India records. Lakshadweep and Chandigarh are too
        small to render reliably at this scale — use{" "}
      ...
      <div className="mt-6 relative border border-borderc rounded-lg bg-white/50 overflow-hidden">
        {geographies.length === 0 ? (
          <p className="text-center py-20 text-muted font-body">Loading map…</p>
        ) : (
          <>
            {hovered && (
