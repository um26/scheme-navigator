...
//
// IMPORTANT: the rule engine, URL filters and source dataset intentionally keep the
// canonical English strings from lib/indianStates.js. Never translate those stored
// values. This helper is only for what a person sees on screen.
...
export function localizeState(locale, state) {
  ...
  return STATE_NAMES[locale]?.[state] || state;
}
